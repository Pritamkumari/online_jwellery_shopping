	...
	while( $chk_sel_rows = mysqli_fetch_assoc($chk_sel_run)){
		...
		echo "
			<tr>
				...
				<td><input type='number' style='width:45px;' min='1' onblur=up_chk_qty(this.value,'$chk_sel_rows[chk_id]'); value='$chk_sel_rows[chk_qty]'></td> "; ?> 
			...
			echo "
					...
					<table class='table'>
						...
						<tbody>
							...
							<tr>
								<td>Grand Total</td>
								<td class='text-right' name='grand_total'><b>$_SESSION[grand_total]/=</b></td>
							</tr> 
						</tbody>
					</table>
