			...
			<div class="row">
				...
				<ol class="breadcrumb">
					...
					<?php 
						...
						$item_title = ucwords($rows['item_title']);
				...
				<?php
							...
							echo "
								<div class='col-md-8'>
									...
									<img src='$rows[item_image]' class='img-responsive' style='width:750px;height:400px;'>
						...
						<ul class="list-group">
							...
							<li class="list-group-item">
								<div class="row">
									...
									<div class="col-md-9">Easy return within 7 days</div>
								</div>
							</li>
							<li class="list-group-item">
								<div class="row">
									<div class="col-md-3"><i class="fa fa-phone fa-2x"></i></div>
									<div class="col-md-9">Call at 9592088164</div>
								</div>
							</li>
						</ul>
					</div>
						...
						echo "
							<div class='col-md-3'>
								<div class='col-md-12 single-item noPadding'>
									<div class='top'><img src='$rel_rows[item_image]' class='img-responsive'></div>
									<div class='bottom'>
